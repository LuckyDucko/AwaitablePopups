...
namespace AwaitablePopups.PopupPages.Login
{
    public class LoginViewModel : PopupViewModel<(string username, string password)>, ILoginViewModel
    {
        ...
        public static async Task<(string username, string password)> GeneratePopup(PopupEntry usernameField, PopupEntry passwordField, PopupButton leftPopupButton, PopupButton rightPopupButton, ICommand leftButtonCommand, ICommand rightButtonCommand, string pictureSource, LoginViewModel autoGeneratedLoginViewModel)
        {
            PropertySetter(usernameField, passwordField, leftPopupButton, rightPopupButton, leftButtonCommand, rightButtonCommand, pictureSource, autoGeneratedLoginViewModel);
        ...
        public static async Task<(string username, string password)> GeneratePopup(PopupEntry usernameField, PopupEntry passwordField, PopupButton leftPopupButton, PopupButton rightPopupButton, Task<(string username, string password)> leftButtonTask, Task<(string username, string password)> rightButtonTask, string pictureSource)
        {
            ...
            return await GeneratePopup(usernameField, passwordField, leftPopupButton, rightPopupButton, leftButtonCommand, rightButtonCommand, pictureSource, AutoGeneratePopupViewModel);
        }
