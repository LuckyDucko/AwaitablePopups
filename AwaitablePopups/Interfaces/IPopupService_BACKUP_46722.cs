...
=======
	public interface IPopupService
	{
		...
		/// 
		/// </summary>
		/// <typeparam name="TSyncActionResult"></typeparam>
		/// <param name="action"></param>
		/// <param name="loaderColour"></param>
		/// <param name="loaderPopupColour"></param>
		/// <param name="reasonsForLoader"></param>
		/// <param name="textColour"></param>
		/// <returns></returns>
		Task<TSyncActionResult> WrapReturnableFuncInLoader<TSyncActionResult>(Func<TSyncActionResult> action,
																		Color loaderColour,
																		Color loaderPopupColour,
																		IEnumerable<string> reasonsForLoader,
																		Color textColour);

		Task<TSyncActionResult> WrapReturnableFuncInLoader<TArgument1, TSyncActionResult>(Func<TArgument1, TSyncActionResult> action, TArgument1 argument1, Color loaderColour, Color loaderPopupColour, IEnumerable<string> reasonsForLoader, Color textColour);
		Task<TSyncActionResult> WrapReturnableFuncInLoader<TArgument1, TArgument2, TSyncActionResult>(Func<TArgument1, TArgument2, TSyncActionResult> action, TArgument1 argument1, TArgument2 argument2, Color loaderColour, Color loaderPopupColour, IEnumerable<string> reasonsForLoader, Color textColour);
		Task<TSyncActionResult> WrapReturnableFuncInLoader<TArgument1, TArgument2, TArgument3, TSyncActionResult>(Func<TArgument1, TArgument2, TArgument3, TSyncActionResult> action, TArgument1 argument1, TArgument2 argument2, TArgument3 argument3, Color loaderColour, Color loaderPopupColour, IEnumerable<string> reasonsForLoader, Color textColour);
		Task<TSyncActionResult> WrapReturnableFuncInLoader<TArgument1, TArgument2, TArgument3, TArgument4, TSyncActionResult>(Func<TArgument1, TArgument2, TArgument3, TArgument4, TSyncActionResult> action, TArgument1 argument1, TArgument2 argument2, TArgument3 argument3, TArgument4 argument4, Color loaderColour, Color loaderPopupColour, IEnumerable<string> reasonsForLoader, Color textColour);
		Task<TSyncActionResult> WrapReturnableFuncInLoader<TArgument1, TArgument2, TArgument3, TArgument4, TArgument5, TSyncActionResult>(Func<TArgument1, TArgument2, TArgument3, TArgument4, TArgument5, TSyncActionResult> action, TArgument1 argument1, TArgument2 argument2, TArgument3 argument3, TArgument4 argument4, TArgument5 argument5, Color loaderColour, Color loaderPopupColour, IEnumerable<string> reasonsForLoader, Color textColour);


		Task<TSyncActionResult> WrapReturnableFuncInLoader<TArgument1, TArgument2, TArgument3, TArgument4, TArgument5, TArgument6, TSyncActionResult>(Func<TArgument1, TArgument2, TArgument3, TArgument4, TArgument5, TArgument6, TSyncActionResult> action, TArgument1 argument1, TArgument2 argument2, TArgument3 argument3, TArgument4 argument4, TArgument5 argument5, TArgument6 argument6, Color loaderColour, Color loaderPopupColour, IEnumerable<string> reasonsForLoader, Color textColour);
		...
		Task<TAsyncActionResult> WrapReturnableTaskInLoader<TAsyncActionResult>(Task<TAsyncActionResult> action, Color loaderColour, Color loaderPopupColour, IEnumerable<string> reasonsForLoader, Color textColor);
		/// <summary>
		/// This is to have TCS 'Tasks' be used with a loader. Do not call a PopupPage through this. 
		/// </summary>
		/// <typeparam name="TAsyncActionResult"></typeparam>
		...
		/// <param name="textColour"></param>
		/// <returns></returns>
		Task<TAsyncActionResult> WrapReturnableTCSInLoader<TAsyncActionResult>(Task<TAsyncActionResult> action, Color loaderColour, Color loaderPopupColour, IEnumerable<string> reasonsForLoader, Color textColour);

		Task WrapTaskInLoader(Task action, Color loaderColour, Color loaderPopupColour, IEnumerable<string> reasonsForLoader, Color textColor);
...
>>>>>>> 12ecd537a65ddd25a4b6b7d50904d17f3cec15ec
}
